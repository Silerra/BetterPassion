namespace BetterPassionIcons
{
    public class Mod
    {
        public const string Id = "de.silerra.betterpassionicons";
        public const string Name = "Better Passion Icons";
        public const string Version = "0.1.0";
        public const string Author = "Silerra";
        public const string PackageId = "BetterPassionIcons";
